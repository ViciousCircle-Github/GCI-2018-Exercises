...
def student_rank(student_log):
    try:
        ...
        print()
        print(sorted_log)
        print("{} has secured 1st rank, scoring {} marks".format(sorted_log[0][0], sorted_log[0][1]))
        print("{} has secured 2nd rank, scoring {} marks".format(sorted_log[1][0], sorted_log[1][1]))
        print("{} has secured 3rd rank, scoring {} marks".format(sorted_log[2][0], sorted_log[2][1]))
        print()
        return sorted_log
    except IndexError:
        print("Enter a minimum 3 students")
        quit()


def student_reward(sorted_log, reward):
    print()
    print("{} has received a cash reward £{}".format(sorted_log[0][0], reward[0]))
    print("{} has received a cash reward £{}".format(sorted_log[1][0], reward[1]))
    print("{} has received a cash reward £{}".format(sorted_log[2][0], reward[2]))
    print()
...
def student_lottery(sorted_log, student_number1):
    ...
    print
    print("{} won the lottery and is receiving £1000".format(sorted_log[rnd][0]))
    print()
